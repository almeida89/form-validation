Este projeto demonstra como criar uma validação de formulário usando HTML, CSS e JavaScript. A validação é realizada em campos de nome de usuário, email, senha e confirmação de senha.
